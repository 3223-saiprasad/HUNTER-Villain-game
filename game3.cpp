...
class character {
  ...
  public:
    ...
    void remaining_health_hero() {
      ...
      int randomNumber = 15 + rand() % 6;
      damage=(health-randomNumber);
...
class player : public character {
 ...
 int main() {
    ...
    cout<<"You have encoutered a Mystical being.\nChoose your action:  ";
    cout<< "|| ATTACK || INVENTORY || RUN || \n";
    cin>>name;
    
    do{
     cout<<"enter no of attack by player \n";
     cout<<"with every attack the health will be reduce by 10 \n";
     cin>>no_of_attack_by_player;
      damage_by_hero=10*no_of_attack_by_player;
      health_of_enemy-=damage_by_hero;
      if(health_of_enemy<=0){
         cout<<"consgratulations you won ! \n";
        break;
     }
    enemy c1(name, health_of_enemy+damage_by_hero, no_of_attack_by_player);
     cout<<"your selected enemy info \n"; 
     c1.showinfo();
     cout<<"Let's start the game \n";
     cout<<"after the attack the remaining health \n";
     c1.remaining_health_villain();
    ...
    player p1("hero",health_of_player+damage_by_enemy,no_of_attack_by_enemy);
